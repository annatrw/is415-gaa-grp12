...
reference if needed
- https://pro.arcgis.com/en/pro-app/3.0/tool-reference/spatial-statistics/h-how-multi-distance-spatial-cluster-analysis-ripl.htm#:~:text=The%20weighted%20K%2Dfunction%20shows,with%20its%20own%20confidence%20envelope).
- https://cran.r-project.org/web/packages/spNetwork/vignettes/KNetworkFunctions.html#:~:text=The%20cross%2DK%2Dfunction%20is,dij%E2%89%A4r%7D
